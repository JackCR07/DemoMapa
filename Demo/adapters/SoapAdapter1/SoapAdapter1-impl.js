...
function CoordManageHttpService_getCoordenada(params, headers){
	var soapEnvNS = '';
    ...
    var mappings = {
		roots: {
			'getCoordenada': { nsPrefix: 'tns', type: 'tns:getCoordenada' }				
		},
    ...
    var namespaces = 'xmlns:ibmSchExtn="http://www.ibm.com/schema/extensions" xmlns:tns="http://CoordManage" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" ';
    var request = buildBody(params, namespaces, mappings, soapEnvNS);
    var soapAction = 'http://CoordManage/getCoordenada';
    return invokeWebService(request, headers, soapAction);
}


function CoordManageHttpService_saveCoordenada(params, headers){
	var soapEnvNS = '';
    // The value of 'soapEnvNS' was set based on the version of the SOAP to be used (i.e. 1.1 or 1.2).
    soapEnvNS = 'http://schemas.xmlsoap.org/soap/envelope/';
    ...
    var mappings = {
		roots: {
			'saveCoordenada': { nsPrefix: 'tns', type: 'tns:saveCoordenada' }				
		},
		
		types: {
			'tns:saveCoordenada': {
				children: [
					{'coordenada': { type: 'tns:Coordenada' }}	
				]
			},
    ...
    var namespaces = 'xmlns:ibmSchExtn="http://www.ibm.com/schema/extensions" xmlns:tns="http://CoordManage" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" ';
    var request = buildBody(params, namespaces, mappings, soapEnvNS);
    var soapAction = 'http://CoordManage/saveCoordenada';
    return invokeWebService(request, headers, soapAction);
}
